...
import org.learn.shiro.core.entity.SysRoleMenuEntity;
...
import org.learn.shiro.util.ShiroUtils;
...
//        List<SysUserEntity> sysUserEntityList = sysUserService.selectUserByName();
//        map.put("sysUserEntityList", sysUserEntityList);
    ...
    public Map<String, Object> getRoleInfoList() {
        Map<String, Object> map = new HashMap<>();
        List<SysRoleEntity> sysRoleEntityList = sysRoleService.selectSysRoleByUserId(1L);
    ...
    public Map<String, Object> getMenuInfoList() {
        Map<String, Object> map = new HashMap<>();
        List<SysMenuEntity> sysMenuEntityList = sysMenuService.selectSysMenuByRoleId(1L);
