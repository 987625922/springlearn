...
import org.learn.shiro.core.entity.SysUserRoleEntity;
import org.learn.shiro.util.SHA256Util;
...
public class UserLoginController {
    ...
    public Map<String, Object> login(@RequestBody SysUserEntity sysUserEntity) {
        ...
        try {
            ...
            UsernamePasswordToken token = new UsernamePasswordToken(sysUserEntity.getUsername(),
